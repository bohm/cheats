...
\fsection{Hašování (řešení kolizí), univerzální hašování, perfektní hašování}
...
\fsection{Perfect hashing}

\fsection{Třídění ve vnitřní a vnější paměti}

\fsection{Dolní odhady pro uspořádání (rozhodovací stromy)}

\TODO{That old lower bound, plus some probabilistic results from PALG.}

\fsection{Dynamizace datových struktur}
...
\fsection{Self-correcting structures}
