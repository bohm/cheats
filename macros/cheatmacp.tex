...
\outer\def\authors#1{{\centerline{\it #1}}\vskip 1ex plus .5ex minus .5ex}
...
\def\claimitem#1#2{{\bf \begingroup\csname#1color\endcsname \csname#1name\endcsname\ifx#2\empty\else(\endgroup{\I #2}\begingroup\csname#1color\endcsname)\fi:\endgroup}}
\def\claim#1#2{\slightnegindent \claimitem{#1}{#2}}

\def\dfnname{D}
\def\dfncolor{\color[rgb]{0.8,0,0}}
\def\dfn#1{\claim{dfn}{#1}}

\def\thmname{T}
\def\thmcolor{\color[rgb]{0,0,0.5}}
\def\thm#1{\claim{thm}{#1}}

\def\lemname{L}
\def\lemcolor{\color[rgb]{1,0,1}}
\def\lem#1{\claim{lem}{#1}}

\def\prfname{P}
\def\prfcolor{\color[rgb]{0,0.5,0}}
\def\prf#1{\claim{prf}{#1}}

\def\obsname{O}
\def\obscolor{\color{black}}
\def\obs#1{\claim{obs}{#1}}

\def\resname{R}
\def\rescolor{\color{black}}
\def\res#1{\claim{res}{#1}}

\def\lclaimname{Claim}
\def\lclaimcolor{\color{black}}
\def\lclaim#1{\claim{lclaim}{#1}}

\def\conjname{Conj}
\def\conjcolor{\color{black}}
\def\conj#1{\claim{conj}{#1}}
